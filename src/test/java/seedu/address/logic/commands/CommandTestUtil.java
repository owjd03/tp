...
public class CommandTestUtil {
    ...
    public static final String VALID_SALARY_BOB = "6000";
    public static final String VALID_DOB_AMY = "1990-01-01";
    public static final String VALID_DOB_BOB = "1992-02-02";
    public static final String VALID_MARITAL_STATUS_AMY = "Single";
    public static final String VALID_MARITAL_STATUS_BOB = "Married";
    ...
    public static final String DOB_DESC_AMY = " " + PREFIX_DATE_OF_BIRTH + VALID_DOB_AMY;
    public static final String DOB_DESC_BOB = " " + PREFIX_DATE_OF_BIRTH + VALID_DOB_BOB;
    public static final String MARITAL_STATUS_DESC_AMY = " " + PREFIX_MARITAL_STATUS + VALID_MARITAL_STATUS_AMY;
    public static final String MARITAL_STATUS_DESC_BOB = " " + PREFIX_MARITAL_STATUS + VALID_MARITAL_STATUS_BOB;
    ...
    public static final String INSURANCE_NAME_DESC_GOLD = " " + PREFIX_INSURANCE_PACKAGE
            + VALID_INSURANCE_PACKAGE_NAME_AMY;
    public static final String INSURANCE_NAME_DESC_SILVER = " " + PREFIX_INSURANCE_PACKAGE
            + VALID_INSURANCE_PACKAGE_NAME_BOB;
    ...
    public static final String INVALID_SALARY_DESC = " " + PREFIX_SALARY + "-5000"; // negative salary not allowed
    ...
    public static final String INVALID_INSURANCE_NAME_DESC = " " + PREFIX_INSURANCE_PACKAGE + ""; // empty string
