...
public class PersonUtil {
    ...
    public static String getEditPersonDescriptorDetails(EditPersonDescriptor descriptor) {
        ...
        descriptor.getMaritalStatus().ifPresent(ms -> sb.append(PREFIX_MARITAL_STATUS).append(ms.value).append(" "));
        descriptor.getDependents().ifPresent(dep -> sb.append(PREFIX_DEPENDENTS).append(dep.toString()).append(" "));
        descriptor.getOccupation().ifPresent(occ -> sb.append(PREFIX_OCCUPATION).append(occ.value).append(" "));
