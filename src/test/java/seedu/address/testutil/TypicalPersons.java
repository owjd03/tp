...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("94351253").withSalary("5000").withDateOfBirth("1999-01-01").withMaritalStatus("Single")
            .withOccupation("Engineer").withDependents(0).withTags("friends").build();
    ...
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("9482427")
            ...
            .withMaritalStatus("Married").withOccupation("Architect").withDependents(3).build();
