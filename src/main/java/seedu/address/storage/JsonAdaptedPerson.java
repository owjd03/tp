...
class JsonAdaptedPerson {
    ...
    public JsonAdaptedPerson(@JsonProperty("name") String name, @JsonProperty("phone") String phone,
            ...
            @JsonProperty("maritalStatus") String maritalStatus, @JsonProperty("occupation") String occupation,
            @JsonProperty("dependents") int dependents, @JsonProperty("tags") List<JsonAdaptedTag> tags) {
        this.name = name;
        this.phone = phone;
        this.email = email;
