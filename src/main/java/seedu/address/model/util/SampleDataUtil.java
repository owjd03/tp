    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                    ...
                    new Dependents(2), new InsurancePackage("Silver",
            ...
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                    ...
                    new InsurancePackage("Bronze", "A foundational plan that covers all your core, essential needs."),
            ...
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                    ...
                    new Dependents(1), new InsurancePackage("Gold",
                            "Our premium, all-inclusive plan offering maximum benefits and total peace of mind."),
                    getTagSet("family")),
