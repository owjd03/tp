    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), new Salary("4000"), new DateOfBirth("1999-02-23"),
                new MaritalStatus("Married"), new Occupation("Manager"), new Dependents(2),
                getTagSet("colleagues", "friends")),
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), new Salary("5000"), new DateOfBirth("1985-10-12"),
                new MaritalStatus("Married"), new Occupation("Director"), new Dependents(3),
                getTagSet("neighbours")),
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new Salary("6000"), new DateOfBirth("1978-05-30"),
                new MaritalStatus("Divorced"), new Occupation("Consultant"), new Dependents(1),
                getTagSet("family")),
